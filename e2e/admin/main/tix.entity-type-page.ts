...
export class EntityTypePage {
    ...
    clickEntityTypeIconAndcheckForPageLoad() {
        ...
        return this.dashboardPage.clickMenuIcon().then(() => {
            return ElementUtil.clickAndWaitForPageLoad(enitityTypeLedgerIcon, loadElement).then(() => {
    ...
    clickAddButtonToCreateEntityType() {
        ...
        return ElementUtil.clickAndWaitForPageLoad(addButton, loadElement).then(() => {
            return browser.sleep(2000).then(() => {
                return $('.cdk-overlay-container .cdk-global-overlay-wrapper div[id^="cdk-overlay-"] md-dialog-container entity-type-dialog h2')
    ...
    createEntityType() {
        ...
        return this.clickAddButtonToCreateEntityType().then((result) => {
            if (result == true) {
